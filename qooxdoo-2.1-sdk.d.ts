...
interface qx_application_Routing {
	...
	on(route: string, handler: qx_lang_Function, scope: any): string;
	on(route: RegExp, handler: qx_lang_Function, scope: any): string;
	onAny(route: string, handler: qx_lang_Function, scope: any): string;
	onAny(route: RegExp, handler: qx_lang_Function, scope: any): string;
	onDelete(route: string, handler: qx_lang_Function, scope: any): string;
	onDelete(route: RegExp, handler: qx_lang_Function, scope: any): string;
	onGet(route: string, handler: qx_lang_Function, scope: any): string;
	onGet(route: RegExp, handler: qx_lang_Function, scope: any): string;
	onPost(route: string, handler: qx_lang_Function, scope: any): string;
	onPost(route: RegExp, handler: qx_lang_Function, scope: any): string;
	onPut(route: string, handler: qx_lang_Function, scope: any): string;
	onPut(route: RegExp, handler: qx_lang_Function, scope: any): string;
...
interface qx_bom_AnimationFrameStatic {
	calculateTiming(func: string, x: number): number;
	request(callback: qx_lang_Function, context: any): number;
}
interface qx_bom_AnimationFrame extends qx_event_Emitter {
...
interface qx_bom_client_CssAnimationStatic {
	...
	getAnimationIteration(): string;
	getAnimationStart(): string;
	getFillMode(): string;
	getKeyFrames(): string;
	getName(): string;
	getPlayState(): string;
	getRequestAnimationFrame(): string;
	getSupport(): any;
}
...
interface qx_bom_client_EcmaScriptStatic {
	getArrayEvery(): bool;
	getArrayFilter(): bool;
	getArrayForEach(): bool;
	getArrayIndexOf(): bool;
	getArrayLastIndexOf(): bool;
	getArrayMap(): bool;
	getArrayReduce(): bool;
	getArrayReduceRight(): bool;
	getArraySome(): bool;
	getDateNow(): bool;
	getErrorToString(): bool;
	getFunctionBind(): bool;
	getObjectKeys(): bool;
...
interface qx_bom_client_OperatingSystemStatic {
	__getVersionForDesktopOs(userAgent: string): string;
	__getVersionForMobileOs(userAgent: string): string;
	getName(): string;
	getVersion(): string;
}
...
interface qx_bom_client_TransportStatic {
	getMaxConcurrentRequestCount(): number;
	getSsl(): bool;
...
interface qx_bom_element_AnimationStatic {
	__hasOnlyCssKeys(el: Element, keyFrames: any): bool;
...
interface qx_bom_element_AnimationCssStatic {
	__addKeyFrames(frames: any, reverse: bool): string;
	__keepFrame(el: Element, endFrame: any): void;
	__normalizeDesc(desc: any): void;
	__onAnimationEnd(e: qx_bom_client_Event): void;
	__onAnimationIteration(e: qx_bom_client_Event): void;
	__onAnimationStart(e: qx_bom_client_Event): void;
...
interface qx_bom_element_DecorationStatic {
	...
	__getStylesForSingleRepeat(style: any, source: string, repeat: string): void;
	...
	create(source: string, repeat: string, style: any): string;
...
interface qx_bom_ElementStatic {
	...
	removeListener(element: Element, type: string, listener: qx_lang_Function, self: any, capture: bool): bool;
	removeListenerById(target: any, id: string): bool;
}
...
interface qx_bom_element_LocationStatic {
	...
	__getBodyLocation(body: Element): any;
...
interface qx_bom_Font extends qx_core_Object {
	_applyBold(value: any, old: any): void;
	_applyColor(value: any, old: any): void;
	_applyDecoration(value: any, old: any): void;
	_applyFamily(value: any, old: any): void;
	_applyItalic(value: any, old: any): void;
	_applyLineHeight(value: any, old: any): void;
	_applySize(value: any, old: any): void;
	_applyTextShadow(value: any, old: any): void;
	getBold(): any;
	getColor(): any;
	getDecoration(): any;
	getFamily(): any;
...
interface qx_bom_History extends qx_core_Object {
	...
	_applyTitle(title: any, old: any): void;
...
interface qx_bom_htmlarea_HtmlAreaStatic {
	...
	__getHtml(root: qx_dom_Node, outputRoot: bool, skipHtmlEncoding: bool, postProcess: qx_lang_Function): string;
...
interface qx_bom_htmlarea_manager_Command extends qx_core_Object {
	...
	__executeCommand(command: string, ui: bool, value: string): bool;
	__executeCommand(command: string, ui: bool, value: number): bool;
	...
	execute(command: string, value: string): bool;
	execute(command: string, value: number): bool;
...
interface qx_bom_htmlarea_manager_UndoRedoStatic {
	new(commandManager: qx_bom_htmlarea_manager_Command, editorInstance: qx_ui_embed_HtmlArea): qx_bom_htmlarea_manager_UndoRedo;
}
interface qx_bom_htmlarea_manager_UndoRedo extends qx_core_Object {
	...
	_handleKeyPress(e: qx_event_type_KeySequence): void;
	...
	isUndoPossible(): bool;
	redo(): bool;
	registerHandler(actionType: string, undoHandler: qx_lang_Function, redoHandler: qx_lang_Function, context: any): void;
...
interface qx_bom_request_Script {
	...
	__environmentGet(key: string): any;
	__failure(): void;
	...
	on(name: string, listener: qx_lang_Function, ctx: any): qx_bom_request_Script;
	onabort(): void;
	onerror(): void;
	onload(): void;
	onloadend(): void;
...
interface qx_bom_request_Xhr {
	...
	getRequest(): any;
	getResponseHeader(header: string): string;
	on(name: string, listener: qx_lang_Function, ctx: any): qx_bom_request_Xhr;
	onabort(): void;
	onerror(): void;
	onload(): void;
	onloadend(): void;
...
interface qx_bom_SelectionStatic {
	__isInputOrTextarea(node: qx_dom_Node): bool;
	get(node: qx_dom_Node): string;
	getEnd(node: qx_dom_Node): number;
	getLength(node: qx_dom_Node): number;
	getSelectionObject(documentNode: Document): qx_bom_Selection;
...
interface qx_bom_Shortcut extends qx_core_Object {
	...
	_applyShortcut(value: any, old: any): void;
...
interface qx_bom_StylesheetStatic {
	...
	createElement(text: string): qx_bom_Stylesheet;
	includeFile(href: string, doc: qx_bom_Document): void;
	...
	removeSheet(sheet: any): void;
}
interface qx_bom_Stylesheet {
}
interface qx_bom_TemplateStatic {
	get(id: string, view: any, partials: any): Element;
...
interface qx_bom_VmlStatic {
	create(type: string, attributes: any, win: any): Element;
...
interface qx_bom_WebWorker extends qx_core_Object {
	...
	_handleError(e: qx_bom_Event): void;
	_handleMessage(e: qx_bom_Event): void;
...
interface qx_bom_WindowStatic {
	...
	close(win: qx_bom_Window): any;
	getBlocker(): qx_bom_Blocker;
	isClosed(win: qx_bom_Window): bool;
	moveTo(win: qx_bom_Window, top: number, left: number): void;
	open(url: string, name: string, options: any, modal: bool, useNativeModalDialog: bool, listener: qx_lang_Function, self: any): qx_bom_Window;
	resizeTo(win: qx_bom_Window, width: number, height: number): void;
}
interface qx_bom_Window {
}
interface qx_BootstrapStatic {
	bind(func: qx_lang_normalize_Function, self: any, varargs: any): qx_lang_normalize_Function;
	debug(object: any, message: any): void;
	define(name: string, config: any): qx_Class;
	error(object: any, message: any): void;
	extendClass(clazz: qx_lang_normalize_Function, construct: qx_lang_normalize_Function, superClass: qx_lang_normalize_Function, name: qx_lang_normalize_Function, basename: qx_lang_normalize_Function): void;
	...
	setDisplayName(fcn: qx_lang_normalize_Function, classname: string, name: string): void;
...
interface qx_ClassStatic {
	...
	__addMembers(clazz: qx_Class, members: any, patch: bool, base: bool, wrap: bool): void;
	__addMixin(clazz: qx_Class, mixin: qx_Mixin, patch: bool): void;
	__addProperties(clazz: qx_Class, properties: any, patch: bool): void;
	__createClass(name: string, type: string, extend: qx_Class, statics: any, construct: qx_lang_normalize_Function, destruct: qx_lang_normalize_Function, mixins: qx_Mixin): qx_Class;
	__createDefaultConstructor(): qx_lang_normalize_Function;
	__createEmptyFunction(): qx_lang_normalize_Function;
	__mixinMemberWrapper(member: qx_lang_normalize_Function, base: qx_lang_normalize_Function): qx_lang_normalize_Function;
	__needsConstructorWrapper(base: qx_Class, mixins: qx_Mixin): bool;
	__retrospectWrapConstruct(clazz: qx_Class): qx_Class;
	...
	__wrapConstructor(construct: qx_lang_normalize_Function, name: string, type: string): qx_lang_normalize_Function;
	define(name: string, config: any): qx_Class;
	genericToString(): string;
...
interface qx_core_AssertStatic {
	...
	__isQxInstance(object: any, classname: string): bool;
	...
	assertException(callback: qx_lang_Function, exception: qx_lang_normalize_Error, re: string, msg: string): void;
	assertException(callback: qx_lang_Function, exception: qx_lang_normalize_Error, re: RegExp, msg: string): void;
...
interface qx_core_GlobalErrorStatic {
	new(exc: qx_lang_normalize_Error, args: any[]): qx_core_GlobalError;
}
interface qx_core_GlobalError extends qx_lang_normalize_Error {
	getArguments(): any;
	getSourceException(): qx_lang_normalize_Error;
	toString(): string;
}
...
interface qx_core_MEventStatic {
}
interface qx_core_MEvent {
...
interface qx_core_PropertyStatic {
	...
	__createRefresher(inheritables: string): qx_lang_Function;
	__emitCallCallback(code: string, config: any, name: string, variant: string): void;
...
interface qx_core_WindowError extends qx_lang_normalize_Error {
...
interface qx_data_controller_MSelection {
	...
	__getSelectableForModel(model: any): any;
...
interface qx_data_controller_Tree extends qx_core_Object {
	...
	__buildTree(): void;
	__changeChildrenArray(e: qx_event_type_Data): void;
...
interface qx_data_marshal_IMarshalerDelegate {
	...
	ignore(properties: string, parentProperty: string, depth: number): string;
	ignore(properties: string, parentProperty: any, depth: number): string;
}
...
interface qx_data_marshal_Json extends qx_core_Object {
	...
	__ignore(hash: string, parentProperty: string, depth: number): bool;
	__ignore(hash: string, parentProperty: any, depth: number): bool;
	__jsonToHash(data: any): string;
	__toClass(data: any, includeBubbleEvents: bool, parentProperty: string, depth: number): void;
	__toClass(data: any, includeBubbleEvents: bool, parentProperty: any, depth: number): void;
	__toModel(data: any, parentProperty: string, depth: number): qx_core_Object;
	__toModel(data: any, parentProperty: any, depth: number): qx_core_Object;
	toClass(data: any, includeBubbleEvents: bool): void;
	toModel(data: any): qx_core_Object;
}
...
interface qx_data_SingleValueBindingStatic {
	...
	__defaultConversion(data: any, targetCheck: string): number;
	...
	resolvePropertyChain(o: qx_core_Object, propertyChain: string): any;
...
interface qx_data_store_Json extends qx_core_Object {
	_applyUrl(value: any, old: any): void;
...
interface qx_dev_DebugStatic {
	debugObject(obj: any, initialMessage: string, maxLevel: number): void;
	debugObject(obj: any, initialMessage: any, maxLevel: number): void;
	debugObjectToString(obj: any, initialMessage: string, maxLevel: number, bHtml: bool): string;
...
interface qx_dev_StackTraceStatic {
	...
	getStackTraceFromError(error: qx_lang_normalize_Error): string;
}
...
interface qx_dev_unit_MRequirementsBasicStatic {
}
interface qx_dev_unit_MRequirementsBasic {
...
interface qx_dev_unit_RequirementError extends qx_lang_normalize_Error {
...
interface qx_dev_unit_TestResult extends qx_core_Object {
	...
	_createError(eventName: string, exceptions: qx_lang_normalize_Error, test: qx_dev_unit_TestSuite): void;
	_createError(eventName: string, exceptions: qx_lang_normalize_Error, test: qx_dev_unit_TestFunction): void;
...
interface qx_event_Emitter {
	...
	addListener(name: string, listener: qx_lang_Function, ctx: any): number;
	addListenerOnce(name: string, listener: qx_lang_Function, ctx: any): number;
	emit(name: string, data: any): void;
	getListeners(): any;
	off(name: string, listener: qx_lang_Function, ctx: any): number;
	offById(id: number): void;
	on(name: string, listener: qx_lang_Function, ctx: any): number;
	once(name: string, listener: qx_lang_Function, ctx: any): number;
	removeListener(name: string, listener: qx_lang_Function, ctx: any): void;
...
interface qx_event_GlobalErrorStatic {
	...
	handleError(ex: qx_lang_normalize_Error): void;
...
interface qx_event_handler_DragDrop extends qx_core_Object {
	...
	__fireEvent(type: string, target: any, relatedTarget: any, cancelable: bool, original: qx_event_type_Mouse): bool;
...
interface qx_event_handler_TouchCore {
	...
	__evaluateTarget(domEvent: qx_bom_client_Event): Element;
...
interface qx_event_Idle extends qx_core_Object {
	_applyTimeoutInterval(value: any, old: any): void;
	_onInterval(): void;
...
interface qx_event_IEventDispatcher {
	...
	canDispatchEvent(target: qx_event_type_Event, event: qx_event_type_Event, type: string): bool;
	dispatchEvent(target: Element, event: qx_event_type_Event, type: string): void;
	dispatchEvent(target: qx_event_type_Event, event: qx_event_type_Event, type: string): void;
}
...
interface qx_event_Messaging {
	...
	_emit(channel: string, path: string, params: any, customData: any): void;
...
interface qx_event_type_MouseWheel extends qx_event_type_Mouse {
	...
	__normalize(delta: number): number;
...
interface qx_event_type_Touch extends qx_event_type_Dom {
	__getEventSpecificTouch(touchIndex: number): any;
...
interface qx_fx_effect_combination_Pulsate extends qx_fx_Base {
	_applyDuration(value: any, old: any): void;
	afterFinish(): void;
	beforeSetup(): void;
	cancel(): void;
	end(): void;
...
interface qx_html_Element extends qx_core_Object {
	...
	fadeIn(duration: number): qx_bom_element_AnimationHandle;
	fadeOut(duration: number): qx_bom_element_AnimationHandle;
	focus(): void;
...
interface qx_html_Iframe extends qx_html_Element {
	...
	reload(): void;
	setName(name: string): qx_html_Iframe;
	setSource(source: string): qx_html_Iframe;
}
...
interface qx_InterfaceStatic {
	...
	__validateConfig(name: string, config: any): void;
	__wrapInterfaceMember(iface: string, origFunction: qx_lang_normalize_Function, functionName: string, preCondition: qx_lang_normalize_Function): qx_lang_normalize_Function;
	assert(clazz: qx_Class, iface: qx_Interface, wrap: bool): void;
	assertObject(object: qx_core_Object, iface: qx_Interface): void;
	define(name: string, config: any): qx_Interface;
...
interface qx_io_remote_ExchangeStatic {
	canHandle(vImpl: any, vNeeds: any, vResponseType: string): bool;
	initTypes(): void;
...
interface qx_io_request_Xhr extends qx_io_request_AbstractRequest {
	...
	setCache(value: any): any;
	setMethod(value: any): any;
	setParser(parser: string): qx_lang_Function;
	setParser(parser: qx_lang_Function): qx_lang_Function;
}
...
interface qx_io_rest_Resource extends qx_core_Object {
	...
	__createRequest(action: string): qx_io_request_AbstractRequest;
	__declareEvent(type: string): void;
	__mapFromDescription(description: any): void;
	_getRequest(): qx_io_request_Xhr;
	...
	poll(action: string, interval: number, params: any, immediately: bool): qx_event_Timer;
...
interface qx_lang_CoreStatic {
	...
	arraySome(callback: qx_lang_Function, obj: any): bool;
...
interface qx_lang_JsonImpl {
	...
	__walk(holder: any, key: string, reviver: qx_lang_Function): any;
	dateToJSON(date: qx_lang_Date): string;
	parse(text: string, reviver: qx_lang_Function): any;
	stringify(value: any, replacer: qx_lang_Function, space: string): string;
}
interface qx_lang_normalize_ArrayStatic {
}
interface qx_lang_normalize_Array {
}
interface qx_lang_normalize_DateStatic {
}
interface qx_lang_normalize_Date {
}
interface qx_lang_normalize_ErrorStatic {
}
interface qx_lang_normalize_Error {
}
interface qx_lang_normalize_FunctionStatic {
}
interface qx_lang_normalize_Function {
}
interface qx_lang_normalize_ObjectStatic {
}
interface qx_lang_normalize_Object {
}
interface qx_lang_normalize_StringStatic {
}
interface qx_lang_normalize_String {
}
...
interface qx_lang_RingBuffer extends qx_util_RingBuffer {
}
...
interface qx_locale_Manager extends qx_core_Object {
	...
	_applyLocale(value: any, old: any): void;
...
interface qx_log_appender_RingBuffer extends qx_util_RingBuffer {
	clearHistory(): void;
	getAllLogEvents(): any[];
...
interface qx_MixinStatic {
	__validateConfig(name: string, config: any): void;
	checkCompatibility(mixins: qx_Mixin): bool;
	define(name: string, config: any): qx_Mixin;
...
interface qx_module_AnimationStatic {
	$init(): void;
	animate(desc: any, duration: number): qxWeb;
	animateReverse(desc: any, duration: number): qxWeb;
	fadeIn(duration: number): qxWeb;
	fadeOut(duration: number): qxWeb;
	getAnimationHandles(): any[];
	isEnded(): bool;
	isPlaying(): bool;
	pause(): qxWeb;
	play(): qxWeb;
...
interface qx_module_AttributeStatic {
	...
	getValue(): string;
	removeAttribute(name: string): qxWeb;
	removeAttributes(attributes: string): qxWeb;
	setAttribute(name: string, value: any): qxWeb;
	setAttributes(attributes: any): qxWeb;
	setHtml(html: string): qxWeb;
	setProperties(properties: any): qxWeb;
	setProperty(name: string, value: any): qxWeb;
	setValue(value: string): qxWeb;
	setValue(value: number): qxWeb;
	setValue(value: any[]): qxWeb;
}
...
interface qx_module_BlockerStatic {
	...
	__attachBlocker(item: qx_bom_Document, color: string, opacity: number, zIndex: number): void;
	__detachBlocker(item: Element, index: number): void;
	__getIframeElement(win: qx_bom_Window): Element;
	...
	__styleBlocker(item: qx_bom_Document, color: string, opacity: number, zIndex: number, isDocument: bool): void;
	block(color: string, opacity: number, zIndex: number): qxWeb;
	unblock(): qxWeb;
}
...
interface qx_module_CoreStatic {
}
interface qx_module_Core {
}
interface qx_module_CssStatic {
	__getDisplayDefault(tagName: string, doc: qx_bom_Document): string;
	addClass(name: string): qxWeb;
	addClasses(names: string): qxWeb;
	getClass(): string;
	getContentHeight(): number;
	getContentWidth(): number;
	getHeight(): number;
	...
	removeClass(name: string): qxWeb;
	removeClasses(names: string): qxWeb;
	replaceClass(oldName: string, newName: string): qxWeb;
	setStyle(name: string, value: any): qxWeb;
	setStyles(styles: any): qxWeb;
	show(): qxWeb;
	toggleClass(name: string): qxWeb;
	toggleClasses(names: string): qxWeb;
}
interface qx_module_Css {
}
interface qx_module_EnvironmentStatic {
	add(key: string, value: any): qxWeb;
	get(key: string): any;
}
...
interface qx_module_EventStatic {
	...
	emit(type: string, data: any): qxWeb;
	hasListener(type: string): bool;
	off(type: string, listener: qx_lang_Function, context: any): qxWeb;
	on(type: string, listener: qx_lang_Function, context: any): qxWeb;
	once(type: string, listener: qx_lang_Function, context: any): qxWeb;
	ready(callback: qx_lang_Function): void;
}
interface qx_module_Event {
}
interface qx_module_event_KeyboardStatic {
	_inputFix(ev: qx_bom_client_Event): void;
	getKeyIdentifier(): string;
	normalize(event: qx_bom_client_Event, element: Element): qx_bom_client_Event;
	registerInputFix(element: Element): void;
	unregisterInputFix(element: Element): void;
}
...
interface qx_module_ManipulatingStatic {
	__animateScroll(property: string, value: number, duration: number): q;
	__getCollectionFromArgument(arg: any): qxWeb;
	__getElementArray(arg: string): Element;
	__getElementArray(arg: Element): Element;
	__getInnermostElement(element: Element): Element;
	after(args: string): qxWeb;
	after(args: Element): qxWeb;
	append(html: string): qxWeb;
	append(html: Element): qxWeb;
	appendTo(parent: string): qxWeb;
	appendTo(parent: Element): qxWeb;
	before(args: string): qxWeb;
	before(args: Element): qxWeb;
	blur(): qxWeb;
	clone(events: bool): qxWeb;
	create(html: string): qxWeb;
	create(html: Element): qxWeb;
	empty(): qxWeb;
	focus(): qxWeb;
	getScrollLeft(): number;
	getScrollTop(): number;
	insertAfter(target: string): qxWeb;
	insertAfter(target: Element): qxWeb;
	insertBefore(target: string): qxWeb;
	insertBefore(target: Element): qxWeb;
	remove(): qxWeb;
	setScrollLeft(value: number, duration: number): qxWeb;
	setScrollTop(value: number, duration: number): qxWeb;
	wrap(wrapper: any): qxWeb;
}
interface qx_module_Manipulating {
}
interface qx_module_MessagingStatic {
	emit(channel: string, path: string, params: any, customData: any): void;
	on(channel: string, type: string, handler: qx_lang_Function, scope: any): string;
	on(channel: string, type: RegExp, handler: qx_lang_Function, scope: any): string;
	onAny(type: string, handler: qx_lang_Function, scope: any): string;
...
interface qx_module_Messaging {
}
interface qx_module_PlaceholderStatic {
	__createPlaceholderElement(item: qxWeb): qxWeb;
	__syncStyles(item: qxWeb): void;
	update(): void;
	updatePlaceholder(): qxWeb;
}
interface qx_module_Placeholder {
}
interface qx_module_PlacementStatic {
	_computePlacement(axes: any, size: any, area: any, target: qxWeb, offsets: any, position: any): any;
	_getAxis(mode: string): any;
	_getPositionX(edge: string, align: string): string;
	_getPositionY(edge: string, align: string): string;
	placeTo(target: Element, position: string, offsets: any, modeX: string, modeY: string): qxWeb;
}
...
interface qx_module_StorageStatic {
	clearLocal(): void;
	clearSession(): void;
	forEachLocal(callback: qx_lang_Function, scope: any): void;
	forEachSession(callback: qx_lang_Function, scope: any): void;
	getLocalItem(key: string): any;
	getLocalKey(index: number): string;
	getLocalLength(): number;
	getSessionItem(key: string): any;
	getSessionKey(index: number): string;
...
interface qx_module_Storage {
}
interface qx_module_TemplateStatic {
	get(id: string, view: any, partials: any): qxWeb;
	render(template: string, view: any, partials: any): string;
}
...
interface qx_module_TransformStatic {
	...
	rotate(value: string): qxWeb;
	rotate(value: any[]): qxWeb;
	scale(value: number): qxWeb;
	scale(value: any[]): qxWeb;
	setTransformBackfaceVisibility(value: bool): qxWeb;
	setTransformOrigin(value: string): qxWeb;
	setTransformPerspective(value: number): qxWeb;
	setTransformPerspectiveOrigin(value: string): qxWeb;
	setTransformStyle(value: string): qxWeb;
	skew(value: string): qxWeb;
	skew(value: any[]): qxWeb;
	transform(transforms: any): qxWeb;
	translate(value: string): qxWeb;
	translate(value: any[]): qxWeb;
}
interface qx_module_Transform {
}
interface qx_module_TraversingStatic {
	__getAncestors(selector: string, filter: string): qxWeb;
	__hierarchyHelper(collection: any[], method: string, selector: string): any[];
	add(el: Element): qxWeb;
	eq(index: number): qxWeb;
	find(selector: string): qxWeb;
	forEach(fn: qx_lang_Function, ctx: any): qxWeb;
	getAncestors(filter: string): qxWeb;
	getAncestorsUntil(selector: string, filter: string): qxWeb;
	getChildren(selector: string): qxWeb;
	getClosest(selector: string): qxWeb;
	getContents(): qxWeb;
	getDocument(node: qx_dom_Node): qx_bom_Document;
	getFirst(): qxWeb;
	getLast(): qxWeb;
	getNext(selector: string): qxWeb;
	getNextAll(selector: string): qxWeb;
	getNextUntil(selector: string): qxWeb;
	getOffsetParent(): qxWeb;
	getParents(selector: string): qxWeb;
	getPrev(selector: string): qxWeb;
	getPrevAll(selector: string): qxWeb;
	getPrevUntil(selector: string): qxWeb;
	getSiblings(selector: string): qxWeb;
	getWindow(node: qx_dom_Node): qx_bom_Window;
	getWindow(node: qx_bom_Document): qx_bom_Window;
	getWindow(node: qx_bom_Window): qx_bom_Window;
	has(selector: string): qxWeb;
	is(selector: string): bool;
	...
	isRendered(): bool;
	not(selector: string): qxWeb;
	not(selector: qx_lang_Function): qxWeb;
}
...
interface qx_PartStatic {
	$$notifyLoad(id: string, closure: qx_lang_normalize_Function): void;
	getInstance(): qx_Part;
	preload(partNames: string): void;
	require(partNames: string, callback: qx_lang_normalize_Function, self: any): void;
...
interface qx_Part {
	...
	preload(partNames: string, callback: qx_lang_normalize_Function, self: any): void;
	require(partNames: string, callback: qx_lang_normalize_Function, self: any): void;
	saveClosure(id: string, closure: qx_lang_normalize_Function): void;
}
...
interface qx_ThemeStatic {
	__checkForInvalidTheme(mixinTheme: qx_Theme): void;
...
interface qx_theme_manager_Color extends qx_util_ValueManager {
	__parseColor(colors: any, name: string): string;
	_applyTheme(value: any, old: any): void;
	getTheme(): any;
	initTheme(value: any): any;
...
interface qx_type_BaseError extends qx_lang_normalize_Error {
	getComment(): string;
	toString(): string;
}
...
interface qx_ui_basic_Atom extends qx_ui_core_Widget {
	_applyCenter(value: any, old: any): void;
	_applyGap(value: any, old: any): void;
	_applyIcon(value: any, old: any): void;
	_applyIconPosition(value: any, old: any): void;
	_applyLabel(value: any, old: any): void;
	_applyRich(value: any, old: any): void;
	_applySelectable(value: any, old: any): void;
...
interface qx_ui_basic_Image extends qx_ui_core_Widget {
	...
	_applySource(value: any, old: any): void;
...
interface qx_ui_basic_Label extends qx_ui_core_Widget {
	__computeContentSize(width: number): any;
	__fixEllipsis(): void;
	_applyBuddy(value: any, old: any): void;
	_applyFont(value: any, old: any): void;
	_applyRich(value: any, old: any): void;
	_applySelectable(value: any, old: any): void;
	_applyTextAlign(value: any, old: any): void;
	_applyTextColor(value: any, old: any): void;
	_applyValue(value: any, old: any): void;
	_applyWrap(value: any, old: any): void;
	_createContentElement(): void;
...
interface qx_ui_container_Stack extends qx_ui_core_Widget {
	...
	_afterAddChild(child: any): void;
	_afterRemoveChild(child: any): void;
	_applyDynamic(value: any, old: any): void;
...
interface qx_ui_control_ColorSelector extends qx_ui_core_Widget {
	...
	_applyBlue(value: any, old: any): void;
	_applyBrightness(value: any, old: any): void;
	_applyGreen(value: any, old: any): void;
	_applyHue(value: any, old: any): void;
	_applyRed(value: any, old: any): void;
	_applySaturation(value: any, old: any): void;
	_createChildControlImpl(id: any, hash: any): void;
...
interface qx_ui_core_Blocker extends qx_core_Object {
	...
	_applyColor(value: any, old: any): void;
	_applyOpacity(value: any, old: any): void;
...
interface qx_ui_core_FocusHandler extends qx_core_Object {
	...
	__findFocusRoot(widget: qx_ui_core_Widget): qx_ui_core_Widget;
	...
	isActive(widget: qx_ui_core_Widget): bool;
	isFocused(widget: qx_ui_core_Widget): bool;
	isFocusRoot(widget: qx_ui_core_Widget): bool;
...
interface qx_ui_core_LayoutItemStatic {
	new(): qx_ui_core_LayoutItem;
}
interface qx_ui_core_LayoutItem extends qx_core_Object {
	_applyAlign(value: any, old: any): void;
	_applyDimension(value: any, old: any): void;
	_applyMargin(value: any, old: any): void;
	_applyStretching(value: any, old: any): void;
...
interface qx_ui_core_MBlocker {
	_applyBlockerColor(value: any, old: any): void;
	_applyBlockerOpacity(value: any, old: any): void;
...
interface qx_ui_core_MContentPadding {
	_applyContentPadding(value: any, old: any): void;
...
interface qx_ui_core_MExecutable {
	...
	_applyCommand(value: any, old: any): void;
	execute(): void;
	getCommand(): any;
...
interface qx_ui_core_MMovable {
	__computeMoveCoordinates(e: qx_event_type_Mouse): any;
...
interface qx_ui_core_MMultiSelectionHandling {
	_applyDragSelection(value: any, old: any): void;
	_applyQuickSelection(value: any, old: any): void;
...
interface qx_ui_core_MPlacement {
	...
	placeToWidget(target: qx_ui_core_Widget, liveupdate: bool): bool;
	resetDomMove(): void;
	resetOffset(): void;
...
interface qx_ui_core_MResizable {
	...
	__computeResizeResult(e: qx_event_type_Mouse): any;
	__getLocation(): any;
...
interface qx_ui_core_queue_AppearanceStatic {
	add(widget: qx_ui_core_Widget): void;
	flush(): void;
	has(widget: qx_ui_core_Widget): bool;
	remove(widget: qx_ui_core_Widget): void;
}
...
interface qx_ui_core_scroll_NativeScrollBar extends qx_ui_core_Widget {
	_applyEnabled(value: any, old: any): void;
	_applyMaximum(value: any, old: any): void;
	_applyOrientation(value: any, old: any): void;
	...
	scrollBy(offset: any, duration: any): void;
	scrollBySteps(steps: any, duration: any): void;
	scrollTo(position: any, duration: any): void;
	setKnobFactor(value: any): any;
	setMaximum(value: any): any;
	setOrientation(value: any): any;
	setPosition(value: any): any;
...
interface qx_ui_core_scroll_ScrollBar extends qx_ui_core_Widget {
	_applyKnobFactor(value: any, old: any): void;
	_applyMaximum(value: any, old: any): void;
	_applyOrientation(value: any, old: any): void;
	_applyPageStep(value: any, old: any): void;
	_applyPosition(value: any, old: any): void;
...
interface qx_ui_core_SingleSelectionManager extends qx_core_Object {
	__applyAllowEmptySelection(value: any, old: any): void;
...
interface qx_ui_core_Widget extends qx_ui_core_LayoutItem {
	...
	_applyAppearance(value: any, old: any): void;
	_applyBackgroundColor(value: any, old: any): void;
	_applyContextMenu(value: any, old: any): void;
	_applyCursor(value: any, old: any): void;
	_applyDecorator(value: any, old: any): void;
	_applyDraggable(value: any, old: any): void;
	_applyDroppable(value: any, old: any): void;
	_applyEnabled(value: any, old: any): void;
	_applyFocusable(value: any, old: any): void;
	_applyFont(value: any, old: any): void;
	_applyKeepActive(value: any, old: any): void;
	_applyKeepFocus(value: any, old: any): void;
	_applyNativeContextMenu(value: any, old: any): void;
	_applyOpacity(value: any, old: any): void;
	_applyPadding(value: any, old: any): void;
	_applySelectable(value: any, old: any): void;
	_applyShadow(value: any, old: any): void;
	_applyTabIndex(value: any, old: any): void;
	_applyTextColor(value: any, old: any): void;
	_applyToolTipText(value: any, old: any): void;
	_applyVisibility(value: any, old: any): void;
	_applyZIndex(value: any, old: any): void;
	_computeSizeHint(): void;
	...
	_createContentElement(): qx_html_Element;
	_createProtectorElement(): void;
	...
	_getDragDropCursor(): qx_ui_core_DragDropCursor;
...
interface qx_ui_decoration_Abstract extends qx_core_Object {
	_applyInsets(value: any, old: any): void;
...
interface qx_ui_decoration_AbstractBox extends qx_ui_decoration_Abstract {
	...
	_applyBaseImage(value: any, old: any): void;
	_applyFill(value: any, old: any): void;
	_applyInsets(value: any, old: any): void;
	_applySlices(value: any, old: any): void;
...
interface qx_ui_decoration_MBackgroundImage {
	...
	_generateMarkup(styles: any, content: string): string;
...
interface qx_ui_decoration_MBorderRadius {
	_applyBorderRadius(value: any, old: any): void;
...
interface qx_ui_decoration_MSingleBorder {
	_applyStyle(value: any, old: any): void;
	_applyWidth(value: any, old: any): void;
...
interface qx_ui_embed_AbstractIframe extends qx_ui_core_Widget {
	__onNavigate(e: qx_event_type_Data): void;
	_applyFrameName(value: any, old: any): void;
	_applySource(value: any, old: any): void;
...
interface qx_ui_embed_Canvas extends qx_ui_core_Widget {
	__redraw(): void;
	_applyCanvasHeight(value: any, old: any): void;
	_applyCanvasWidth(value: any, old: any): void;
	_createContentElement(): void;
...
interface qx_ui_embed_Flash extends qx_ui_core_Widget {
	...
	_applyId(value: any, old: any): void;
	_applyLiveConnect(value: any, old: any): void;
	_applyLoop(value: any, old: any): void;
	_applyMayScript(value: any, old: any): void;
	_applyMenu(value: any, old: any): void;
	_applyPlay(value: any, old: any): void;
...
interface qx_ui_embed_Html extends qx_ui_core_Widget {
	_applyCssClass(value: any, old: any): void;
	_applyFont(value: any, old: any): void;
	_applyHtml(value: any, old: any): void;
	_applySelectable(value: any, old: any): void;
	_applyTextColor(value: any, old: any): void;
	getCssClass(): any;
...
interface qx_ui_embed_HtmlArea extends qx_ui_core_Widget {
	...
	_applyContentType(value: any, old: any): void;
	_applyDefaultFontFamily(value: any, old: any): void;
	_applyDefaultFontSize(value: any, old: any): void;
	_applyInsertLinebreakOnCtrlEnter(value: any, old: any): void;
	_applyInsertParagraphOnLinebreak(value: any, old: any): void;
	_applyMessengerMode(value: any, old: any): void;
	_applyNativeContextMenu(value: any, old: any): void;
	_applyPostProcess(value: any, old: any): void;
	_applyUseUndoRedo(value: any, old: any): void;
...
interface qx_ui_embed_Iframe extends qx_ui_embed_AbstractIframe {
	_applyNativeContextMenu(value: any, old: any): void;
	_applyNativeHelp(value: any, old: any): void;
...
interface qx_ui_form_AbstractField extends qx_ui_core_Widget {
	...
	_applyEnabled(value: any, old: any): void;
	_applyFont(value: any, old: any): void;
	_applyPlaceholder(value: any, old: any): void;
	_applyReadOnly(value: any, old: any): void;
	_applyTextAlign(value: any, old: any): void;
	_applyTextColor(value: any, old: any): void;
	_createContentElement(): void;
...
interface qx_ui_form_AbstractSelectBox extends qx_ui_core_Widget {
	_applyMaxListHeight(value: any, old: any): void;
	_createChildControlImpl(id: any, hash: any): void;
...
interface qx_ui_form_core_AbstractVirtualBox extends qx_ui_core_Widget {
	...
	_applyMaxListHeight(value: any, old: any): void;
	_applyModel(value: any, old: any): void;
	_applyRowHeight(value: any, old: any): void;
	_beforeClose(): void;
	_beforeOpen(): void;
	_createChildControlImpl(id: any, hash: any): void;
...
interface qx_ui_form_core_VirtualDropDownList extends qx_ui_popup_Popup {
	...
	_applySelection(value: any, old: any): void;
	_createChildControlImpl(id: any, hash: any): void;
	_handleKeyboard(event: qx_event_type_KeySequence): void;
	_handleMouse(event: qx_event_type_Mouse): void;
...
interface qx_ui_form_DateField extends qx_ui_core_Widget {
	...
	_applyDateFormat(value: any, old: any): void;
	_applyPlaceholder(value: any, old: any): void;
	_createChildControlImpl(id: any, hash: any): void;
	_onBlur(e: qx_event_type_Focus): void;
...
interface qx_ui_form_Form extends qx_core_Object {
	...
	redefineResetterItem(item: qx_ui_core_Widget): void;
	reset(): void;
	validate(): bool;
}
...
interface qx_ui_form_List extends qx_ui_core_scroll_AbstractScrollArea {
	_applyOrientation(value: any, old: any): void;
	_applySpacing(value: any, old: any): void;
...
interface qx_ui_form_MForm {
	...
	_applyValid(value: any, old: any): void;
...
interface qx_ui_form_RadioButtonGroup extends qx_ui_core_Widget {
	_applyInvalidMessage(value: any, old: any): void;
	_applyValid(value: any, old: any): void;
	add(child: qx_ui_core_LayoutItem, options: any): void;
	getChildren(): qx_ui_core_LayoutItem;
	getInvalidMessage(): any;
...
interface qx_ui_form_RadioGroup extends qx_core_Object {
	__onChangeSelection(e: qx_event_type_Data): void;
	_applyAllowEmptySelection(value: any, old: any): void;
	_applyEnabled(value: any, old: any): void;
	_applyInvalidMessage(value: any, old: any): void;
	_applyValid(value: any, old: any): void;
...
interface qx_ui_form_Resetter extends qx_core_Object {
	__getCurrentValue(item: qx_ui_core_Widget): any;
...
interface qx_ui_form_Slider extends qx_ui_core_Widget {
	__animateTo(to: number, duration: number): void;
	__computeTrackingEnd(e: qx_event_type_Mouse): void;
	_applyKnobFactor(value: any, old: any): void;
	_applyMaximum(value: any, old: any): void;
	_applyMinimum(value: any, old: any): void;
	_applyOrientation(value: any, old: any): void;
	_applyValue(value: any, old: any): void;
	_createChildControlImpl(id: any, hash: any): void;
	_fireValue(): void;
...
interface qx_ui_form_TextArea extends qx_ui_form_AbstractField {
	...
	_applyAutoSize(value: any, old: any): void;
	_applyDimension(value: any, old: any): void;
	_applyMinimalLineHeight(value: any, old: any): void;
	_applyWrap(value: any, old: any): void;
	_createInputElement(): void;
...
interface qx_ui_form_validation_Manager extends qx_core_Object {
	...
	__isAsyncValidator(validator: qx_ui_form_validation_AsyncValidator): bool;
	...
	__validateItem(dataEntry: any, value: any): bool;
	__validateRequired(formItem: qx_ui_core_Widget): any;
...
interface qx_ui_layout_Abstract extends qx_core_Object {
	...
	_getWidget(): qx_ui_core_Widget;
	_renderSeparator(separator: qx_html_Decorator, bounds: any): void;
...
interface qx_ui_layout_HBox extends qx_ui_layout_Abstract {
	__rebuildCache(): void;
	_applyReversed(value: any, old: any): void;
	_computeSizeHint(): void;
	getAlignX(): any;
	getAlignY(): any;
	getReversed(): any;
...
interface qx_ui_layout_UtilStatic {
	...
	computeHorizontalSeparatorGaps(children: qx_ui_core_LayoutItem, spacing: number, separator: qx_html_Decorator): number;
	...
	computeVerticalSeparatorGaps(children: qx_ui_core_LayoutItem, spacing: number, separator: qx_html_Decorator): number;
}
...
interface qx_ui_list_core_MWidgetController {
	...
	__getBindPath(index: number, path: string, type: string): string;
	__getBindPath(index: number, path: any, type: string): string;
...
interface qx_ui_list_List extends qx_ui_virtual_core_Scroller {
	...
	_applyGroupLabelPath(value: any, old: any): void;
	_applyIconOptions(value: any, old: any): void;
	_applyIconPath(value: any, old: any): void;
	_applyLabelOptions(value: any, old: any): void;
	_applyLabelPath(value: any, old: any): void;
...
interface qx_ui_menu_AbstractButton extends qx_ui_core_Widget {
	...
	_applyLabel(value: any, old: any): void;
	_applyMenu(value: any, old: any): void;
	_applyShowCommandLabel(value: any, old: any): void;
	_createChildControlImpl(id: any, hash: any): void;
...
interface qx_ui_menu_Menu extends qx_ui_core_Widget {
	...
	_applyArrowColumnWidth(value: any, old: any): void;
	_applyBlockerColor(value: any, old: any): void;
	_applyBlockerOpacity(value: any, old: any): void;
	_applyIconColumnWidth(value: any, old: any): void;
	_applyOpenedButton(value: any, old: any): void;
	_applySelectedButton(value: any, old: any): void;
	_applySpacingX(value: any, old: any): void;
	_applySpacingY(value: any, old: any): void;
	_applyVisibility(value: any, old: any): void;
	_assertSlideBar(callback: qx_lang_Function): any;
	_computePlacementSize(): any;
	_createChildControlImpl(id: any, hash: any): void;
	_getMenuBounds(): any;
...
interface qx_ui_mobile_basic_Image extends qx_ui_mobile_core_Widget {
	...
	initSource(value: any): any;
	resetSource(): void;
	setDraggable(isDraggable: bool): void;
	setSource(value: any): any;
}
...
interface qx_ui_mobile_container_CarouselStatic {
	new(transitionDuration: number): qx_ui_mobile_container_Carousel;
}
interface qx_ui_mobile_container_Carousel extends qx_ui_mobile_container_Composite {
	_applyShowPagination(value: any, old: any): void;
	_doScrollLoop(pageIndex: number): void;
	_onContainerUpdate(): void;
	_onPaginationLabelTap(): void;
	_onSwipe(evt: qx_event_type_Swipe): void;
	_onTouchMove(evt: qx_event_type_Touch): void;
	_onTouchStart(evt: qx_event_type_Touch): void;
	_setScrollersOpacity(opacity: number): void;
	_setShowTransition(showTransition: bool): void;
	_snapCarouselPage(): void;
	_updateCarouselLayout(): void;
	_updatePagination(oldActiveIndex: number, newActiveIndex: number): void;
	_updateScrollerPosition(x: number, y: number): void;
	add(page: qx_ui_mobile_container_Composite): void;
	getScrollLoop(): any;
	getShownPageIndex(): number;
	getShowPagination(): any;
	initScrollLoop(value: any): any;
	initShowPagination(value: any): any;
	nextPage(): void;
	previousPage(): void;
	removePageByIndex(pageIndex: number): void;
	resetScrollLoop(): void;
	resetShowPagination(): void;
	scrollToPage(pageIndex: number, showTransition: bool): void;
	setScrollLoop(value: any): any;
	setShowPagination(value: any): any;
	setSwipeVelocityLimit(limit: number): void;
}
...
interface qx_ui_mobile_container_MIScroll {
	...
	_scrollToElement(elementId: string, time: number): void;
	_setScroll(scroll: any): void;
	disable(): void;
	enable(): void;
}
...
interface qx_ui_mobile_container_Scroll extends qx_ui_mobile_container_Composite {
	...
	scrollToElement(elementId: string, time: number): void;
}
interface qx_ui_mobile_container_ScrollCompositeStatic {
	new(layout: qx_ui_mobile_layout_Abstract): qx_ui_mobile_container_ScrollComposite;
}
interface qx_ui_mobile_container_ScrollComposite extends qx_ui_mobile_container_Composite {
	_fixChildElementsHeight(evt: qx_event_type_Data): void;
	_handleSize(child: qx_ui_mobile_core_Widget): void;
	_onTouchEnd(evt: qx_event_type_Touch): void;
	_onTouchMove(evt: qx_event_type_Touch): void;
	_onTouchStart(evt: qx_event_type_Touch): void;
	_unhandleSize(child: qx_ui_mobile_core_Widget): void;
	add(child: any, options: any): void;
	addAfter(child: any, after: any, layoutProperties: any): void;
	addAt(child: any, index: any, options: any): void;
	addBefore(child: any, before: any, layoutProperties: any): void;
	getChildren(): void;
	getLayout(): void;
	hasChildren(): void;
...
interface qx_ui_mobile_core_Root extends qx_ui_mobile_container_Composite {
	_applyShowScrollbarY(value: any, old: any): void;
	_createContainerElement(): void;
...
interface qx_ui_mobile_core_Widget extends qx_core_Object {
	...
	_applyDefaultCssClass(value: any, old: any): void;
	...
	setEnabled(value: any): any;
	setId(value: any): any;
	setLayoutParent(parent: qx_ui_mobile_core_Widget): void;
...
interface qx_ui_mobile_dialog_BusyIndicator extends qx_ui_mobile_basic_Atom {
	_applySpinnerClass(value: any, old: any): void;
...
interface qx_ui_mobile_dialog_Manager extends qx_core_Object {
	...
	__showNonNativeDialog(title: string, text: string, handler: qx_lang_Function, scope: any, buttons: string, dialogType: number): qx_ui_mobile_dialog_Dialog;
	alert(title: string, text: string, handler: qx_lang_Function, scope: any, button: string): qx_ui_mobile_dialog_Dialog;
	confirm(title: string, text: string, handler: qx_lang_Function, scope: any, buttons: string): qx_ui_mobile_dialog_Dialog;
	error(title: string, text: string, handler: qx_lang_Function, scope: any, button: string): qx_ui_mobile_dialog_Dialog;
	input(title: string, text: string, handler: qx_lang_Function, scope: any, buttons: string): qx_ui_mobile_dialog_Dialog;
	wait(title: string, text: string, handler: qx_lang_Function, scope: any, buttons: string): qx_ui_mobile_dialog_Dialog;
	warning(title: string, text: string, handler: qx_lang_Function, scope: any, button: string): qx_ui_mobile_dialog_Dialog;
}
interface qx_ui_mobile_dialog_MenuStatic {
	new(itemsModel: qx_data_Array, anchor: qx_ui_mobile_core_Widget): qx_ui_mobile_dialog_Menu;
}
interface qx_ui_mobile_dialog_Menu extends qx_ui_mobile_dialog_Dialog {
	__onBlockerTap(): void;
	__onClearButtonTap(): void;
	__onListChangeSelection(evt: qx_event_type_Data): void;
	__onListTap(): void;
	_applyClearButtonLabel(value: any, old: any): void;
	_applyNullable(value: any, old: any): void;
	_createSelectionList(): qx_ui_mobile_list_List;
	_render(): void;
	getClearButtonLabel(): any;
	getHideOnBlockerClick(): any;
	getNullable(): any;
	getSelectedItemClass(): any;
	getUnselectedItemClass(): any;
	initClearButtonLabel(value: any): any;
	initHideOnBlockerClick(value: any): any;
	initNullable(value: any): any;
	...
	setClearButtonLabel(value: any): any;
	setHideOnBlockerClick(value: any): any;
	setItems(itemsModel: qx_data_Array): void;
	setNullable(value: any): any;
	setSelectedIndex(selectedIndex: number): void;
	setSelectedItemClass(value: any): any;
	setUnselectedItemClass(value: any): any;
}
interface qx_ui_mobile_dialog_PickerStatic {
	new(anchor: qx_ui_mobile_core_Widget): qx_ui_mobile_dialog_Picker;
}
interface qx_ui_mobile_dialog_Picker extends qx_ui_mobile_dialog_Dialog {
	_createPickerSlot(slotIndex: number): qx_ui_mobile_container_Composite;
	_createPickerValueLabel(textValue: string): qx_ui_mobile_basic_Label;
	_decreaseSelectedIndex(contentElement: Element): void;
	_fireConfirmSelection(): void;
	_fixPickerSlotHeight(target: Element): void;
	_getModelByElement(contentElement: Element): qx_data_Array;
	_getSlotIndexByElement(contentElement: Element): number;
	_increaseSelectedIndex(contentElement: Element): void;
	_isSelectedIndexValid(contentElement: Element, selectedIndex: number): bool;
	_onTouchEnd(evt: qx_event_type_Touch): void;
	_onTouchMove(evt: qx_event_type_Touch): void;
	_onTouchStart(evt: qx_event_type_Touch): void;
	_render(): void;
	_updateAllSlots(): void;
	_updateSlot(targetElement: Element): void;
	addSlot(slotData: qx_data_Array): void;
	confirm(): void;
	getSlotCount(): number;
	removeSlot(slotIndex: number): void;
	setCancelButtonCaption(caption: string): void;
	setConfirmButtonCaption(caption: string): void;
	setSelectedIndex(slotIndex: number, value: number): void;
	show(): void;
}
...
interface qx_ui_mobile_dialog_Popup extends qx_ui_mobile_core_Widget {
	...
	__unregisterEventListener(): void;
	_applyIcon(value: any, old: any): void;
	_applyTitle(value: any, old: any): void;
	...
	removeWidget(): qx_ui_mobile_core_Widget;
	resetIcon(): void;
	resetTitle(): void;
...
interface qx_ui_mobile_embed_CanvasStatic {
	new(): qx_ui_mobile_embed_Canvas;
}
interface qx_ui_mobile_embed_Canvas extends qx_ui_mobile_core_Widget {
	_getTagName(): void;
	getCanvas(): Element;
	getContext2d(): CanvasRenderingContext2D;
	getHeight(): number;
...
interface qx_ui_mobile_form_Form extends qx_ui_form_Form {
	...
	_getItemByIndex(groupIndex: number, rowIndex: number): qx_ui_form_IForm;
	getInvalidItems(): qx_ui_mobile_core_Widget;
...
interface qx_ui_mobile_form_GroupStatic {
	new(widgets: qx_ui_mobile_core_Widget, showBorder: bool): qx_ui_mobile_form_Group;
}
interface qx_ui_mobile_form_Group extends qx_ui_mobile_container_Composite {
	_onChangeShowBorder(): void;
	getShowBorder(): any;
	initShowBorder(value: any): any;
	resetShowBorder(): void;
	setShowBorder(value: any): any;
}
...
interface qx_ui_mobile_form_LabelStatic {
	new(value: string): qx_ui_mobile_form_Label;
}
interface qx_ui_mobile_form_Label extends qx_ui_mobile_core_Widget {
	_applyValue(value: any, old: any): void;
	_applyWrap(value: any, old: any): void;
	_getTagName(): void;
	getValue(): any;
...
interface qx_ui_mobile_form_MText {
	_applyMaxLength(value: any, old: any): void;
	blur(): void;
	focus(): void;
	getMaxLength(): any;
	getPlaceholder(): any;
...
interface qx_ui_mobile_form_renderer_Single extends qx_ui_mobile_form_renderer_AbstractRenderer {
	_addGroupFooterRow(): void;
	_addGroupHeader(title: string): void;
	_addGroupHeaderRow(): void;
	_addInOneLine(item: qx_ui_mobile_core_Widget, name: string): void;
	_addInScrollComposite(item: qx_ui_mobile_core_Widget, name: string): void;
	_addInSeparateLines(item: qx_ui_mobile_core_Widget, name: string): void;
	_addSeparationRow(): void;
	_getTagName(): void;
	_isOneLineWidget(item: qx_ui_mobile_core_Widget): bool;
	addButton(button: any): void;
	addItems(items: any, names: any, title: any): void;
	hideItem(item: qx_ui_form_IForm): void;
	resetForm(): void;
	showErrorForItem(item: any): void;
	showItem(item: qx_ui_form_IForm): void;
}
interface qx_ui_mobile_form_renderer_SinglePlaceholderStatic {
	new(form: qx_ui_mobile_form_Form): qx_ui_mobile_form_renderer_SinglePlaceholder;
}
...
interface qx_ui_mobile_form_SelectBox extends qx_ui_mobile_core_Widget {
	...
	_applyModel(value: qx_data_Array, old: qx_data_Array): void;
	_applyNullable(isNullable: any, old: any): void;
	_createContainerElement(): void;
	_createSelectionDialog(): qx_ui_mobile_dialog_Menu;
	_getTagName(): void;
	_getValue(): number;
...
interface qx_ui_mobile_form_Slider extends qx_ui_mobile_core_Widget {
	...
	getMaximum(): any;
	getMinimum(): any;
	getReverseDirection(): any;
	getStep(): any;
	initMaximum(value: any): any;
	initMinimum(value: any): any;
	initReverseDirection(value: any): any;
	initStep(value: any): any;
	nextValue(): void;
	previousValue(): void;
	resetMaximum(): void;
	...
	setMaximum(value: any): any;
	setMinimum(value: any): any;
	setReverseDirection(value: any): any;
	setStep(value: any): any;
}
...
interface qx_ui_mobile_form_ToggleButton extends qx_ui_mobile_core_Widget {
	_checkLastTouchTime(): bool;
	_createChild(): qx_ui_mobile_container_Composite;
...
interface qx_ui_mobile_list_List extends qx_ui_mobile_core_Widget {
	__onModelChange(evt: qx_event_type_Data): void;
	__render(): void;
	__renderRow(index: number): void;
	_applyDelegate(value: any, old: any): void;
	_applyModel(value: any, old: any): void;
	_getTagName(): void;
	_onTap(evt: qx_event_type_Tap): void;
...
interface qx_ui_mobile_list_renderer_Abstract extends qx_ui_mobile_container_Composite {
	_applySelected(value: any, old: any): void;
	_applyShowArrow(value: any, old: any): void;
	_getTagName(): void;
...
interface qx_ui_mobile_navigation_ManagerStatic {
	getInstance(): qx_ui_mobile_navigation_Manager;
...
interface qx_ui_mobile_navigation_Manager extends qx_core_Object {
	...
	__getFromHistory(path: string): any;
	__onChangeHash(evt: qx_event_type_Data): void;
	_addRoute(operation: string, route: string, handler: qx_lang_Function, scope: any): number;
	_addRoute(operation: string, route: RegExp, handler: qx_lang_Function, scope: any): number;
	...
	onAny(route: string, handler: qx_lang_Function, scope: any): number;
	onAny(route: RegExp, handler: qx_lang_Function, scope: any): number;
	onDelete(route: string, handler: qx_lang_Function, scope: any): number;
	onDelete(route: RegExp, handler: qx_lang_Function, scope: any): number;
	onGet(route: string, handler: qx_lang_Function, scope: any): number;
	onGet(route: RegExp, handler: qx_lang_Function, scope: any): number;
	onPost(route: string, handler: qx_lang_Function, scope: any): number;
	onPost(route: RegExp, handler: qx_lang_Function, scope: any): number;
	onPut(route: string, handler: qx_lang_Function, scope: any): number;
	onPut(route: RegExp, handler: qx_lang_Function, scope: any): number;
	remove(id: string): void;
}
...
interface qx_ui_mobile_page_NavigationPageStatic {
	new(wrapContentByGroup: bool, layout: qx_ui_mobile_layout_Abstract): qx_ui_mobile_page_NavigationPage;
}
interface qx_ui_mobile_page_NavigationPage extends qx_ui_mobile_page_Page {
	_applyBackButtonText(value: any, old: any): void;
	_applyButtonText(value: any, old: any): void;
	_applyContentCssClass(value: any, old: any): void;
	_applyShowBackButton(value: any, old: any): void;
	_applyShowButton(value: any, old: any): void;
	_applyTitle(value: any, old: any): void;
	...
	getNavigationBarHidden(): any;
	getNavigationBarToggleDuration(): any;
	...
	initNavigationBarHidden(value: any): any;
	initNavigationBarToggleDuration(value: any): any;
	...
	resetTitle(): void;
	scrollTo(x: number, y: number, time: number): void;
	scrollToWidget(widget: qx_ui_mobile_core_Widget, time: number): void;
	setBackButtonText(value: any): any;
	setButtonText(value: any): any;
	setContentCssClass(value: any): any;
	setIsTablet(isTablet: bool): void;
	setNavigationBarHidden(value: any): any;
	setNavigationBarToggleDuration(value: any): any;
...
interface qx_ui_mobile_tabbar_TabButton extends qx_ui_mobile_form_Button {
	_applyView(value: any, old: any): void;
	getView(): any;
...
interface qx_ui_progressive_renderer_Abstract extends qx_core_Object {
	...
	render(state: qx_ui_progressive_State, element: any): void;
}
...
interface qx_ui_progressive_renderer_table_Row extends qx_ui_progressive_renderer_Abstract {
	__linkColors(): void;
	_resizeColumns(e: qx_event_type_Event): void;
	addRenderer(column: number, renderer: qx_ui_progressive_renderer_table_cell_Abstract): void;
...
interface qx_ui_splitpane_Pane extends qx_ui_core_Widget {
	...
	_applyOffset(value: any, old: any): void;
...
interface qx_ui_table_cellrenderer_Boolean extends qx_ui_table_cellrenderer_AbstractImage {
	_applyIconFalse(value: any, old: any): void;
	_applyIconTrue(value: any, old: any): void;
	_getCellStyle(cellInfo: any): void;
	_identifyImage(cellInfo: any): void;
	_onChangeTheme(): void;
	getIconFalse(): any;
...
interface qx_ui_table_cellrenderer_Dynamic extends qx_ui_table_cellrenderer_Default {
	createDataCellHtml(cellInfo: any, htmlArr: string): string;
...
interface qx_ui_table_columnmodel_Resize extends qx_ui_table_columnmodel_Basic {
	...
	_applyBehavior(value: any, old: any): void;
...
interface qx_ui_table_headerrenderer_HeaderCell extends qx_ui_container_Composite {
	_applyIcon(value: any, old: any): void;
	_applyLabel(value: any, old: any): void;
	_applySortIcon(value: any, old: any): void;
	_createChildControlImpl(id: any, hash: any): void;
	getIcon(): any;
	getLabel(): any;
	getSortIcon(): any;
...
interface qx_ui_table_pane_Model extends qx_core_Object {
	_applyFirstColumnX(value: any, old: any): void;
	_applyMaxColumnCount(value: any, old: any): void;
...
interface qx_ui_table_pane_Pane extends qx_ui_core_Widget {
	...
	_applyFirstVisibleRow(value: any, old: any): void;
	_applyMaxCacheLines(value: any, old: any): void;
	_applyVisibleRowCount(value: any, old: any): void;
	_getContentHint(): void;
...
interface qx_ui_table_pane_Scroller extends qx_ui_core_Widget {
	...
	_applyHorizontalScrollBarVisible(value: any, old: any): void;
	_applyScrollTimeout(value: any, old: any): void;
	_applyShowCellFocusIndicator(value: any, old: any): void;
	_applyTablePaneModel(value: any, old: any): void;
	_applyVerticalScrollBarVisible(value: any, old: any): void;
	_createChildControlImpl(id: any, hash: any): void;
...
interface qx_ui_table_rowrenderer_Default extends qx_core_Object {
	...
	getRowClass(rowInfo: any): void;
	getRowHeightStyle(height: number): string;
...
interface qx_ui_table_Table extends qx_ui_core_Widget {
	...
	_applyColumnVisibilityButtonVisible(value: any, old: any): void;
	_applyContextMenuFromDataCellsOnly(value: any, old: any): void;
	_applyFocusCellOnMouseMove(value: any, old: any): void;
	_applyHeaderCellHeight(value: any, old: any): void;
	_applyHeaderCellsVisible(value: any, old: any): void;
	_applyKeepFirstVisibleRowComplete(value: any, old: any): void;
	_applyMetaColumnCounts(value: any, old: any): void;
	_applyResetSelectionOnHeaderClick(value: any, old: any): void;
	_applyRowHeight(value: any, old: any): void;
	_applySelectionModel(value: any, old: any): void;
	_applyShowCellFocusIndicator(value: any, old: any): void;
	_applyStatusBarVisible(value: any, old: any): void;
	_applyTableModel(value: any, old: any): void;
...
interface qx_ui_tabview_Page extends qx_ui_container_Composite {
	...
	_applyIcon(value: any, old: any): void;
	_applyLabel(value: any, old: any): void;
	_applyShowCloseButton(value: any, old: any): void;
	_createChildControlImpl(id: any, hash: any): void;
	_onButtonClose(): void;
...
interface qx_ui_toolbar_ToolBar extends qx_ui_core_Widget {
	...
	_applyOverflowHandling(value: any, old: any): void;
	_applyOverflowIndicator(value: any, old: any): void;
	_applyShow(value: any, old: any): void;
	_applySpacing(value: any, old: any): void;
	_computeSizeHint(): void;
...
interface qx_ui_tooltip_Manager extends qx_core_Object {
	...
	_applyCurrent(value: any, old: any): void;
	getCurrent(): any;
...
interface qx_ui_tree_core_AbstractItem extends qx_ui_core_Widget {
	...
	_addWidgets(): void;
	_applyIcon(value: any, old: any): void;
	_applyIconOpened(value: any, old: any): void;
	_applyIndent(value: any, old: any): void;
	_applyLabel(value: any, old: any): void;
	_applyOpen(value: any, old: any): void;
...
interface qx_ui_tree_core_MWidgetController {
	__addBinding(widget: qx_ui_core_Widget, id: any): void;
	__getBindings(widget: qx_ui_core_Widget): any[];
	__getBindPath(index: number, path: string): string;
	__getBindPath(index: number, path: any): string;
	_bindItem(item: qx_ui_core_Widget, index: number): void;
	_removeBindingsFrom(item: qx_ui_core_Widget): void;
	bindDefaultProperties(item: qx_ui_core_Widget, index: number): void;
	bindProperty(sourcePath: string, targetProperty: string, options: any, targetWidget: qx_ui_core_Widget, index: number): void;
...
interface qx_ui_tree_Tree extends qx_ui_core_scroll_AbstractScrollArea {
	_applyHideRoot(value: any, old: any): void;
	_applyOpenMode(value: any, old: any): void;
	_applyRoot(value: any, old: any): void;
	_applyRootOpenClose(value: any, old: any): void;
	_getContentPaddingTarget(): qx_ui_core_Widget;
	_onChangeSelection(e: qx_event_type_Data): void;
	_onKeyPress(e: qx_event_type_KeySequence): void;
...
interface qx_ui_tree_VirtualTree extends qx_ui_virtual_core_Scroller {
	...
	_applyChildProperty(value: any, old: any): void;
	_applyDelegate(value: any, old: any): void;
	_applyHideRoot(value: any, old: any): void;
	_applyIconOptions(value: any, old: any): void;
	_applyIconPath(value: any, old: any): void;
	...
	_applyOpenMode(value: any, old: any): void;
	_applyRowHeight(value: any, old: any): void;
	_applyShowLeafs(value: any, old: any): void;
	_applyShowTopLevelOpenCloseIcons(value: any, old: any): void;
...
interface qx_ui_treevirtual_SimpleTreeDataModel extends qx_ui_table_model_Abstract {
	...
	_applyFilter(value: any, old: any): void;
...
interface qx_ui_virtual_behavior_Prefetch extends qx_core_Object {
	_applyInterval(value: any, old: any): void;
	_applyScroller(value: any, old: any): void;
	_onInterval(): void;
	getInterval(): any;
	getScroller(): any;
	initInterval(value: any): any;
...
interface qx_ui_virtual_form_List extends qx_ui_virtual_core_Scroller {
	...
	_applyDelegate(value: any, old: any): void;
	_applyRowCount(value: any, old: any): void;
	_applyRowHeight(value: any, old: any): void;
	_applyShowGridLines(value: any, old: any): void;
	_applyUseWidgetCells(value: any, old: any): void;
	_createChildControlImpl(id: any, hash: any): void;
...
interface qx_ui_virtual_form_ListController extends qx_core_Object {
	__buildUpLookupTable(): void;
	__lookup(index: number): qx_core_Object;
	_applyDelegate(value: any, old: any): void;
	_applyModel(value: any, old: any): void;
	_applySelection(value: any, old: any): void;
	_applyTarget(value: any, old: any): void;
...
interface qx_ui_virtual_layer_AbstractBackground extends qx_ui_virtual_layer_Abstract {
	_applyColorEven(value: any, old: any): void;
	_applyColorOdd(value: any, old: any): void;
...
interface qx_ui_virtual_layer_CellSpanManager extends qx_core_Object {
	...
	_getSingleCellBounds(cell: any, firstVisibleRow: any, firstVisibleColumn: any): any;
...
interface qx_ui_window_MDesktop {
	...
	_afterAddChild(win: qx_ui_core_Widget): void;
	_afterRemoveChild(win: qx_ui_core_Widget): void;
	_applyActiveWindow(value: any, old: any): void;
...
interface qx_ui_window_Window extends qx_ui_core_Widget {
	...
	_applyModal(value: any, old: any): void;
	_applyShowStatusbar(value: any, old: any): void;
	_applyStatus(value: any, old: any): void;
	_createChildControlImpl(id: any, hash: any): void;
	_getContentPaddingTarget(): qx_ui_core_Widget;
...
interface qx_util_format_DateFormatStatic {
	getDateInstance(): qx_util_format_DateFormat;
	getDateTimeInstance(): qx_util_format_DateFormat;
...
interface qx_util_fsm_State extends qx_core_Object {
	__bindIfFunction(f: qx_lang_Function, context: any): qx_lang_Function;
	__bindIfFunction(f: any, context: any): qx_lang_Function;
...
interface qx_util_RingBufferStatic {
	new(maxEntries: number): qx_util_RingBuffer;
}
interface qx_util_RingBuffer {
	__addToIndex(idx: number, addMe: number): number;
...
interface qxWebStatic {
	$attach(module: any): void;
	$attachInit(init: qx_lang_normalize_Function): void;
	$attachStatic(module: any): void;
	$init(arg: any): q;
	define(name: string, config: any): qx_lang_normalize_Function;
	get(key: string): string;
	escapeRegexpChars(str: string): string;
	firstUp(str: string): string;
	...
	getLocalKey(index: number): string;
	startsWith(fullstr: string, substr: string): bool;
	ready(callback: qx_lang_normalize_Function): void;
	...
	$registerEventHook(types: string, registerHook: qx_lang_normalize_Function, unregisterHook: qx_lang_normalize_Function): void;
	getSessionKey(index: number): string;
	on(channel: string, type: string, handler: qx_lang_normalize_Function, scope: any): string;
	on(channel: string, type: RegExp, handler: qx_lang_normalize_Function, scope: any): string;
	onAny(type: string, handler: qx_lang_normalize_Function, scope: any): string;
	onAny(type: RegExp, handler: qx_lang_normalize_Function, scope: any): string;
	firstLow(str: string): string;
	isDocument(node: any): bool;
	clearLocal(): void;
	max(arr: any[]): number;
	...
	create(html: Element): qxWeb;
	getLocalItem(key: string): any;
	$unregisterNormalization(types: string, normalizer: qx_lang_normalize_Function): void;
	render(template: string, view: any, partials: any): string;
	endsWith(fullstr: string, substr: string): bool;
	setSessionItem(key: string, value: any): void;
	isElement(element: any): bool;
	...
	setLocalItem(key: string, value: any): void;
	script(url: string): qx_bom_request_Script;
	forEachLocal(callback: qx_lang_normalize_Function, scope: any): void;
	forEachSession(callback: qx_lang_normalize_Function, scope: any): void;
	exclude(arr1: any[], arr2: any[]): any[];
	getLocalLength(): number;
	get(id: string, view: any, partials: any): qxWeb;
	update(): void;
	$getRegistry(): any;
	insertAfter(arr: any[], obj: any, obj2: any): any[];
	cast(object: any, constructor: qx_lang_normalize_Function, offset: number): any[];
	removeSessionItem(key: string): void;
	hyphenate(str: string): string;
	getSessionItem(key: string): any;
	unique(arr: any[]): any[];
	...
	insertBefore(arr: any[], obj: any, obj2: any): any[];
	min(arr: any[]): number;
	$registerNormalization(types: string, normalizer: qx_lang_normalize_Function): void;
	$getHookRegistry(): any;
	jsonp(url: string, settings: any): qx_bom_request_Jsonp;
	$unregisterEventHook(types: string, registerHook: qx_lang_normalize_Function, unregisterHook: qx_lang_normalize_Function): void;
	new(selector: string, context: Element): qxWeb;
	new(selector: Element, context: Element): qxWeb;
	new(selector: any[], context: Element): qxWeb;
}
interface qxWeb extends qx_type_BaseArray {
	concat(varargs: any): q;
	filter(selector: string): q;
	filter(selector: qx_lang_normalize_Function): q;
	map(callback: qx_lang_normalize_Function, thisarg: any): q;
	slice(begin: number, end: number): q;
	splice(index: number, howMany: number, varargs: any): q;
	getOffsetParent(): qxWeb;
	show(): qxWeb;
	setTransformStyle(value: string): qxWeb;
	updatePlaceholder(): qxWeb;
	...
	getScrollLeft(): number;
	focus(): qxWeb;
	forEach(fn: qx_lang_normalize_Function, ctx: any): qxWeb;
	not(selector: string): qxWeb;
	not(selector: qx_lang_normalize_Function): qxWeb;
	getNextUntil(selector: string): qxWeb;
	setAttributes(attributes: any): qxWeb;
	animateReverse(desc: any, duration: number): qxWeb;
	remove(): qxWeb;
	...
	toggleClasses(names: string): qxWeb;
	isPlaying(): bool;
	on(type: string, listener: qx_lang_normalize_Function, context: any): qxWeb;
	block(color: string, opacity: number, zIndex: number): qxWeb;
	setTransformPerspective(value: number): qxWeb;
	removeAttribute(name: string): qxWeb;
	getAttribute(name: string): any;
	...
	getScrollTop(): number;
	is(selector: string): bool;
	is(selector: qx_lang_normalize_Function): bool;
	getNextAll(selector: string): qxWeb;
	getHtml(): string;
	getOffset(): any;
	getHeight(): number;
	...
	getStyle(name: string): any;
	getFirst(): qxWeb;
	off(type: string, listener: qx_lang_normalize_Function, context: any): qxWeb;
	hasClass(name: string): bool;
	isEnded(): bool;
	placeTo(target: Element, position: string, offsets: any, modeX: string, modeY: string): qxWeb;
	once(type: string, listener: qx_lang_normalize_Function, context: any): qxWeb;
}
...
interface qx_bomStatic {
	AnimationFrame: qx_bom_AnimationFrameStatic;
...
interface qx_dev_unitStatic {
	...
	MRequirementsBasic: qx_dev_unit_MRequirementsBasicStatic;
...
interface qx_lang_normalizeStatic {
	Array: qx_lang_normalize_ArrayStatic;
	Date: qx_lang_normalize_DateStatic;
	Error: qx_lang_normalize_ErrorStatic;
	Function: qx_lang_normalize_FunctionStatic;
	Object: qx_lang_normalize_ObjectStatic;
	String: qx_lang_normalize_StringStatic;
}
interface qx_langStatic {
	...
	normalize: qx_lang_normalizeStatic;
...
interface qx_moduleStatic {
	...
	Messaging: qx_module_MessagingStatic;
	Placeholder: qx_module_PlaceholderStatic;
	Placement: qx_module_PlacementStatic;
	Polyfill: qx_module_PolyfillStatic;
	Storage: qx_module_StorageStatic;
...
interface qx_ui_mobile_containerStatic {
	Carousel: qx_ui_mobile_container_CarouselStatic;
	...
	ScrollComposite: qx_ui_mobile_container_ScrollCompositeStatic;
}
...
interface qx_ui_mobile_dialogStatic {
	...
	Picker: qx_ui_mobile_dialog_PickerStatic;
	Popup: qx_ui_mobile_dialog_PopupStatic;
}
interface qx_ui_mobile_embedStatic {
	Canvas: qx_ui_mobile_embed_CanvasStatic;
...
interface qx_ui_mobile_formStatic {
	...
	Label: qx_ui_mobile_form_LabelStatic;
...
interface qx_utilStatic {
	...
	RingBuffer: qx_util_RingBufferStatic;
