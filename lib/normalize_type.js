...
function normalizeType(type, rootItem, index) {
	...
	if(!type || type === 'Any' || type === 'Map' || type === 'map' || type === 'Object' || type === 'object' || type === 'varargs' || type === 'Arguments' || type === 'arguments' || type === 'Obj' || type === 'var' || type === 'Var' || type === 'Null' || type === 'null' || type.match(/[^\w._$]/)) {
		return 'any';
	}
